...
if __name__ == '__main__':
    ...
    if len(sys.argv) != 4: # Modified to expect 4 arguments now (script name, architecture, model dir, image path)
        print("The script needs three arguments.") # Updated message
    ...
    #fto = open(output, 'w') # Removed output file
    ...
    print(predicted_class_label) # Only print the label for Flask to capture

    #fto.write(image_path) # Removed file writing
    #fto.write("***")
